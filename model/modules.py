...
from typings_ import PreprocessConfig, ModelConfig
...
class VarianceAdaptor(nn.Module):
    ...
    def __init__(self, preprocess_config: PreprocessConfig, model_config: ModelConfig):
        ...
        num_encoder_hidden = model_config["transformer"]["encoder_hidden"]
        self.pitch_embedding = nn.Embedding(n_bins, num_encoder_hidden)
        self.energy_embedding = nn.Embedding(n_bins, num_encoder_hidden)
